            ...
            if st.form_submit_button("SALVAR REGISTRO"):
                ...
                if codigo_input:
                    ...
                    if salvar_nc(dados):
                        ...
                        st.session_state["nc_sku"] = ""  # Limpa SKU

                        st.session_state["nc_rua"] = ""  # Limpa Rua

                        st.session_state["nc_obs"] = ""  # Limpa Obs

                        

                        # Reseta Selectbox e Radio para o primeiro item
                        ...
                        time.sleep(1) # Pequena pausa para ler a msg de sucesso
